...
class TableQuestion:
    ...
    @classmethod
    def from_state_dict(cls, state_dict, table: Optional[Union[Table, List[Table], TableQuestionDataSet]] = None) -> TableQuestion:
        """ Creates empty instance and loads the serialized values from the state_dict
            instead of recomputing them.
        """
        instance = cls.__new__(cls)
        ...
        instance._table = restore_table_from_id(state_dict['aggregation_column'], table)
