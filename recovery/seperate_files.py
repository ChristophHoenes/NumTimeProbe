...
def main(save_directory='dump_scan'):
    search_files = [
        SearchFile(file_name='table_creation', header=None, footer='table.column_names = tuple(table.deduplicate_column_names(table.column_names))', dump_files=['dump_files/source_code_dump.txt'], max_length=110, footer_slack=20),
    ]
...
if __name__ == "__main__":
    main(save_directory='dump_scan_table_creation')
